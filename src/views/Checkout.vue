<template>
    <div class="page-checkout">
        <div class="columns is-multiline">
            ...
            <div class="column is-12 box">
                <h2 class="subtitle">Заказ</h2>

                <p class="has-text-grey mb-4">* Заполните все поля</p>
...
export default {
    ...
    mounted() {
        ...
        if (this.cartTotalLength > 0) {
            this.stripe = Stripe('pk_test_51L75UmIvSx5NuJ4d64XgF8YOh53JCkS8TiJhYuWlXwdNFWy60TxiXMwEQ39OrfrGddOOY7jY4sTI8juP2eOTePk000KFxKtRqI')
